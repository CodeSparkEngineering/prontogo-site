...
// Botão flutuante de WhatsApp — canal directo para pedidos rápidos.
// Não renderiza se o link não estiver configurado em lib/site.ts.
export default function WhatsappButton() {
  if (!contactoWhatsapp) return null;
